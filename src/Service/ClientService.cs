...
namespace Service
{
    // Interface Que permite que el API tenga acceso a los metodos 
    ...
    public class ClientService : IClientService
    {
        ...
        // Como se usa una clase Dto y lo que resive es de tipo Cliente se instala paquete Automaper para mapear las dos clases
